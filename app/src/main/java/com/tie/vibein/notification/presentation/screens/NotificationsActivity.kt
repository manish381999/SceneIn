...
import com.tie.vibein.databinding.ActivityNotificationsBinding
...
import com.tie.vibein.notifications.data.models.HeaderData
import com.tie.vibein.notifications.data.models.Notification
import com.tie.vibein.notifications.presentation.adapter.NotificationsAdapter
...
class NotificationsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.swipeRefreshLayout.setOnRefreshListener { notificationViewModel.fetchNotifications(currentUserId) }
    }
    ...
    private fun loadDataAndMarkAsRead() {
        ...
        Handler(Looper.getMainLooper()).postDelayed({
            notificationViewModel.markNotificationsAsRead(currentUserId)
        }, 3000)
    }
