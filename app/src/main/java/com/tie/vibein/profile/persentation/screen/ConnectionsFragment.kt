...
import com.tie.vibein.chat.persentation.screens.ChatActivity // Import ChatActivity
import com.tie.vibein.databinding.FragmentConnectionsBinding
import com.tie.vibein.profile.persentation.adapter.ConnectionsAdapter
...
class ConnectionsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.fetchMyConnections(currentLoggedInUserId)
    }
    ...
    private fun showDisconnectConfirmationDialog(userName: String, userIdToDisconnect: String) {
        MaterialAlertDialogBuilder(requireContext())
            ...
            .setPositiveButton("Disconnect") { _, _ ->
                viewModel.removeConnection(currentLoggedInUserId, userIdToDisconnect)
            }
            .show()
    }
