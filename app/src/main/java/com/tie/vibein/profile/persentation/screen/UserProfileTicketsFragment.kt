...
import com.tie.vibein.databinding.FragmentUserProfileTicketsBinding
import com.tie.vibein.profile.persentation.view_model.ProfileViewModel
import com.tie.vibein.tickets.persentation.adapter.MyTicketsAdapter
...
class UserProfileTicketsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (!userId.isNullOrEmpty()) {
            viewModel.fetchMyTicketsActivity(userId!!)
        }
    }
