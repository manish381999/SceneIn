...
import com.tie.vibein.databinding.ActivityProfilePicturePreviewBinding
    ...
    private fun setupClickListeners() {
        ...
        binding.actionConnect.setOnClickListener {
            ...
            when (status) {
                ...
                "pending" -> profileViewModel.removeConnection(currentUserId, pId)
                "accepted" -> profileViewModel.removeConnection(currentUserId, pId)
            }
        }
