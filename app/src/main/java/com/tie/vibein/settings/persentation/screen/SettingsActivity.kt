package com.tie.vibein.settings.persentation.screen
...
import com.tie.dreamsquad.utils.SP.ACCOUNT_IS_PRIVATE
import com.tie.dreamsquad.utils.SP.NOTIFICATIONS_PAUSED
import com.tie.vibein.R
import com.tie.vibein.credentials.presentation.screens.LoginActivity
import com.tie.vibein.databinding.ActivitySettingsBinding
import com.tie.vibein.profile.persentation.screen.EditProfileActivity
import com.tie.vibein.settings.data.models.SettingsItem
import com.tie.vibein.settings.persentation.adapter.SettingsAdapter
import com.tie.vibein.settings.presentation.viewmodel.SettingsViewModel
import com.tie.vibein.tickets.persentation.screens.PayoutSetupActivity
...
class SettingsActivity : AppCompatActivity() {
    ...
    private fun buildSettingsList(): List<SettingsItem> {
        ...
        val isAccountPrivate = SP.getBoolean(this, SP.ACCOUNT_IS_PRIVATE, false)
        ...
        return listOf(
            ...
            SettingsItem.ToggleItem(
                ...
                viewModel.updateAccountPrivacy(currentUserId, isChecked)
            },
            SettingsItem.Spacer,
    ...
    private fun showLogoutConfirmation() {
        CustomAlertDialog.show(
            ...
            onPositiveClick = {
                ...
                viewModel.logout(currentUserId)
            }
        )
    }
    ...
    private fun showAccountDeletionConfirmation() {
        CustomAlertDialog.show(
            ...
            onPositiveClick = {
                // The button click's only job is to call the ViewModel.
                viewModel.deleteAccount(currentUserId) // Assuming you have renamed deleteAccount
            }
        )
    }
